...
@Component({
  selector: 'app-angular-experience',
  templateUrl: './angular-experience.component.html',
  styleUrls: ['./angular-experience.component.css'],
  animations: [
...
export class AngularExperienceComponent {
